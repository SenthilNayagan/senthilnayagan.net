...
imageDescription: The harmonious interaction between dog owners and their pets serves as a metaphor for the Rust programming language's approach to memory management through its ownership system.
...
{% include "postImage.html" src: "./images/stealing.jpg", alt: "Designed by Freepik", description: "<b>Figure 1: </b>Stealing.", credits: "Designed by Freepik" %}
...
{% include "postImage.html" src: "./images/leakage.jpg", alt: "Designed by Freepik", description: "<b>Figure 2: </b>Leakage.", credits: "Designed by Freepik" %}
...
{% include "postImage.html" src: "./images/memory-unsafety-vs-memory-leaks.png", alt: "Created by Author", description: "<b>Figure 3: </b>Memory unsafety vs. memory leaks." %}
...
{% include "postImage.html" src: "./images/rust-stands-out.png", alt: "Created by Author", description: "<b>Figure 4: </b>Rust has better control over memory management and provide higher safety with no memory issues." %}
...
{% include "postImage.html" src: "./images/explicit-mem-vs-implicit-mem.png", alt: "Created by Author", description: "<b>Figure 5: </b>Explicit memory management vs. Implicit memory management vs. Rust’s ownership model." %}
...
{% include "postImage.html" src: "./images/rust-ownership.webp", alt: "Created by Author", description: "<b>Figure 6: </b>Metaphorically reflects Rust's ownership.", credits: "Image generated by DALL-E." %}
...
{% include "postImage.html" src: "./images/variable-binding.png", alt: "Created by Author", description: "<b>Figure 7: </b>Variable binding shows the owner and its value/resource." %}
...
{% include "postImage.html" src: "./images/stack-holds-metadata.png", alt: "Created by Author", description: "<b>Figure 9: </b>The stack holds the metadata while the heap holds the actual contents." %}
...
{% include "postImage.html" src: "./images/variable-s2-gets-a-copy.png", alt: "Created by Author", description: "<b>Figure 10: </b>Variable `s2` gets a copy of the pointer, length, and capacity of `s1`." %}
...
{% include "postImage.html" src: "./images/data-replication.png", alt: "Created by Author", description: "<b>Figure 11: </b>If Rust copied the heap data, another possibility for what `let s2 = s1` might do is data replication. However, Rust does not copy by default." %}
...
{% include "postImage.html" src: "./images/after-s1-invalidated.png", alt: "Created by Author", description: "<b>Figure 12: </b>Memory representation after `s1` has been invalidated." %}
...
{% include "postImage.html" src: "./images/heap-data-copied-into-s2.png", alt: "Created by Author", description: "<b>Figure 13: </b>When using the clone method, the heap data does get copied into `s2`." %}
...
{% include "postImage.html" src: "./images/a-guy-walking-with-dogs.jpeg", alt: "Designed by Freepik", description: "<b>Figure 14: </b>A guy walking with dogs." %}
...
{% include "postImage.html" src: "./images/compiler-copies-x-to-y-and-z.png", alt: "Created by Author", description: "<b>Figure 15: </b>Compiler made copies of `x` to both `y` and `z`." %}
...
{% include "postImage.html" src: "./images/mem-representation-after-s1-dropped.png", alt: "Created by Author", description: "<b>Figure 16: </b>Memory representation after `s1` has been dropped." %}
...
{% include "postImage.html" src: "./images/nervous-breakdown.png", alt: "Designed by Freepik", description: "<b>Figure 17: </b>Woman going through nervous breakdown." %}
...
{% include "postImage.html" src: "./images/a-girl-borrows-a-book-from-a-librarian.webp", alt: "Designed by Freepik", description: "<b>Figure 18: </b>A girl borrows a book from a librarian. Generated by DALL.E" %}
...
{% include "postImage.html" src: "./images/stack-mem-representation.png", alt: "Created by Author", description: "<b>Figure 19: </b>Stack memory representation." %}
